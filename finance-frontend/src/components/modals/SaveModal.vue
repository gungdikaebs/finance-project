      ...
      <div class="px-5 sm:px-6 py-4 border-b border-stone-100 dark:border-[#243329] flex items-center justify-between shrink-0 bg-white dark:bg-[#16201A]">
        <div class="flex items-center gap-2.5">
          ...
          <div>
            ...
            <span class="text-[11px] text-emerald-800 dark:text-[#B8DF38] font-bold">Aturan D-005: 60% Dana Pengaman & 40% Target Impian</span>
          </div>
        </div>
      ...
      <div class="p-5 sm:p-6 overflow-y-auto flex-1 overscroll-contain space-y-4">
        ...
        <div class="p-3.5 bg-emerald-50/70 dark:bg-emerald-950/20 border border-emerald-200/80 dark:border-emerald-800/30 rounded-xl text-xs space-y-1">
          ...
          <p class="text-[11px] text-stone-500 dark:text-[#98A79D] leading-relaxed font-normal">
            Penyisihan ini menandai alokasi mental komitmen uang ke pos tabungan tanpa memindahkannya keluar dari rekening bank.
          </p>
        </div>
        ...
        <div class="space-y-3.5">
          <div>
            <div class="flex justify-between items-center mb-1.5">
              <label class="block text-xs font-bold text-[#18221B] dark:text-[#F0F4F1]">Nominal yang Disisihkan (Rp)</label>
          ...
          <div v-if="savePreviewData && savePreviewData.previewItems.length > 0" class="space-y-2 pt-3 border-t border-stone-100 dark:border-[#243329]">
