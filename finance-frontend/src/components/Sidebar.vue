      ...
      <div class="space-y-1">
        ...
        <button type="button" @click="emit('navigate', 'ringkasan')"
          ...
          <LayoutDashboard class="w-4 h-4 shrink-0"
            :class="activeSection === 'ringkasan' ? 'text-[#183D2B]' : 'text-[#18221B]/50'" />
        ...
        <button type="button" @click="emit('navigate', 'tabungan')"
          ...
          <Target class="w-4 h-4 shrink-0"
            :class="activeSection === 'tabungan' ? 'text-[#183D2B]' : 'text-[#18221B]/50'" />
        ...
        <button type="button" @click="emit('navigate', 'anggaran')"
          ...
          <PieChart class="w-4 h-4 shrink-0"
            :class="activeSection === 'anggaran' ? 'text-[#183D2B]' : 'text-[#18221B]/50'" />
        ...
        <button type="button" @click="emit('navigate', 'analitik')"
          ...
          <TrendingUp class="w-4 h-4 shrink-0"
            :class="activeSection === 'analitik' ? 'text-[#183D2B]' : 'text-[#18221B]/50'" />
        ...
        <button type="button" @click="emit('navigate', 'transaksi')"
          ...
          <ReceiptText class="w-4 h-4 shrink-0"
            :class="activeSection === 'transaksi' ? 'text-[#183D2B]' : 'text-[#18221B]/50'" />
    ...
    <div class="p-4 border-t border-emerald-950/10 space-y-3 bg-canvas/30">
      ...
      <div class="flex items-center justify-between px-2 pt-1">
        <div class="flex items-center space-x-2.5 min-w-0">
          <div
            class="w-8 h-8 rounded-xl bg-[#183D2B]/10 text-[#183D2B] font-bold text-xs flex items-center justify-center shrink-0">
